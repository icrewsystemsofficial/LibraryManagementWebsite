            ...
            <div class="row lg-auto">
                <div id="content">
                    <div class="title">
                        ...
                        <p style="font-size: medium">Kunj Vihar, 5th St., Bhubaneswar, Odisha - 751022</p>
                        <h3>Mail Us at :</h3>
                        <p style="font-size: medium" ><a href = "mailto:literarium@gmail.com">literarium@gmail.com</a></p>
                        <h3>Call us:</h3>
                        <p style="font-size: medium">+91-7123456789</p>
                    </div>
                </div>
        </div>
        </div>
